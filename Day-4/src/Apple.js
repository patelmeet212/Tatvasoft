...
export const Apple = () => {
  ...
  const [email, setEmail] = useState("Meet@Test123.com");
    ...
    <div style={{ padding: 13 }}>
      ...
      >
        <div onClick={handleClick} style={{ cursor: "pointer" }}>
          <Avatar sx={{ bgcolor: blue[500], color: grey[50], marginRight: 15 }}>
            MP
          </Avatar>
          <span style={{ fontSize: 16, fontWeight: "bold" }}>Meet Patel</span>
        </div>
      </div>
      <Grid item>
